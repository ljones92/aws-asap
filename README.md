...
aws-asap/0.2.3 darwin-x64 node-v12.18.2
$ asap --help [COMMAND]
USAGE
  $ asap COMMAND
...
...
_See code: [src/commands/ps.ts](https://github.com/ljones92/aws-asap/blob/v0.2.3/src/commands/ps.ts)_
...
_See code: [src/commands/sm.ts](https://github.com/ljones92/aws-asap/blob/v0.2.3/src/commands/sm.ts)_
<!-- commandsstop -->
